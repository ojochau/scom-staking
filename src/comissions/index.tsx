...
import { ICommissionInfo, IEmbedData, INetwork, formatNumber, isWalletAddress } from '../global/index';
import ScomNetworkPicker from './network-picker';
import { SupportedNetworks, getEmbedderCommissionFee, getNetworkName } from '../store/index';
...
@customModule
@customElements("i-scom-staking-config")
